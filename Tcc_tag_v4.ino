 ...
 for(int i =0 ; i<1024;i++)
   ...
   if (status == MI_OK)
  {
    ...
    status= MFRC522_SelectTag(&serNum[0]);
      if(status!=0){
          Serial.println("Card selecionado com sucesso");
          Read_Tag();
      }
      else{
    ...
    Serial.println("Problemas no Request/Cartao nao encontrado");
    }  

  //Serial.println("Nenhum card encontrado");
  //MFRC522_Halt();
